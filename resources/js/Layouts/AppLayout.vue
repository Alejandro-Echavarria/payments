                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex w-full">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <p class="font-extrabold text-gray-700 dark:text-gray-200"><span
                                        class="h-12 w-12">MAET</span> / Payments</p>
                                </Link>
                            </div>
                                ...
                                <div class="ml-3 relative">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            ...
                                            <DropdownLink :href="route('billings.index')">
                                                Billings
                                            </DropdownLink>
                    ...
                    <template v-if="$page.props.auth.user">
                        <div class="pt-4 pb-1 border-t border-gray-200">
                            ...
                            <div class="mt-3 space-y-1">
                                ...
                                <ResponsiveNavLink :href="route('billings.index')"
                                    :active="route().current('billings.index')">
                                    Billings
                                </ResponsiveNavLink>
