            ...
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 list-inside list-none">
                            <li class="mb-4">
                                <a href="https://github.com/Alejandro-Echavarria" class="hover:underline" target="_blank"
                                    rel="noreferrer noopener nofollow">Github</a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/manuel-alejandro-echavarria-taveras-7587b518b/"
                                    class="hover:underline" target="_blank" rel="noreferrer noopener nofollow">Linkedin</a>
                            </li>
                        </ul>
                    </div>
                    <div>
